...
def import_products_handeler():
    product_directory = filedialog.askopenfilename(initialdir=r"C:\Users\tayor\Desktop\legacy_api", title="Please select products file")
    import_directory = filedialog.askopenfilename(initialdir=r"C:\Users\tayor\Desktop\legacy_api", title="Please select products file")
    functions.product_handeler(product_directory, import_directory)
...
import_products = Button (root, text="Import / Update Products", padx=25, pady=25, command=import_products_handeler)
#update_products = Button (root, text="Updates Products", padx=25, pady=25, command=import_products_handeler)
