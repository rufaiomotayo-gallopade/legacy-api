...
def make_parents_contacts_to_company():
    contact_directory = filedialog.askopenfilename(initialdir="C:/", title="Please select contact file")
    company_directory = filedialog.askopenfilename(initialdir="C:/", title="Please select company file")
    functions.make_parents("contact", "company", contact_directory, company_directory)
